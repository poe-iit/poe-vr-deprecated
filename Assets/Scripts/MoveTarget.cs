...
{
    public GameObject[] NavMeshExits;
    ...
    void assignLocation(Vector3 PassedLocation)
    {



        for (int i=0; i<NavMeshExits.Length; i++)
        {
            if (NavMeshExits[i]==null)
            {
                //NavMeshExits[i] = PassedLocation;
            }
        }
    }
}